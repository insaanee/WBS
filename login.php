...
if($_POST) {		
	...
	if(empty($username) || empty($password)) {
		...
		if($result->num_rows == 1) {
			$password =$password;
			// exists
			$mainSql = "SELECT * FROM users WHERE username = '$username' AND password = '$password'  AND type = '1' ";
...
<html>
<head>
	<title>Wholesale Buying & Selling System</title>
			...
			<div class="col-md-5 col-md-offset-4">
					<div class="card">
						  <div class="cardHeader">
							...
							<h2><image src="image/sslogo.png" style="height:50px;width:70px;">Wholesale Buying & Selling System</h2>
						  </div>	 
					</div> 
