	...
	$("#addProductModalBtn").unbind('click').bind('click', function() {
		...
		$("#submitProductForm").unbind('submit').bind('submit', function() {
			...
			if(quantity == "" || quantity < 1 ) {
				$("#quantity").after('<p class="text-danger">Quantity field is required Or can not less than 1</p>');
			...
			if(rate == "" || rate < 1 ) {
				$("#rate").after('<p class="text-danger">Rate field is required Or can not less than 1</p>');
			...
			if(cost == "" || cost < 1 ) {
				$("#cost").after('<p class="text-danger">Cost field is required Or can not less than 1</p>');
			...
			if(productImage && productName && quantity > 0 && rate > 0 && cost > 0 && brandName && categoryName && productStatus) {
